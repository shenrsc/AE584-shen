...
plot(T,w_1(:,1),'LineWidth',3);
plot(T,O1_solutions(1,:),'color','#D95319','LineStyle','--','LineWidth',2);
plot(T,O2_solutions(1,:),'LineWidth',2,'color','y','LineStyle','-.');
title('phi versus time');
xlabel('time(s)');
legend('angle','angle from O matrix in a','angle from O matrix in b');
hold off

subplot(1,3,2);
hold on
plot(T,w_1(:,2),'LineWidth',3);
plot(T,O1_solutions(2,:),'color','#D95319','LineStyle','--','LineWidth',2);
plot(T,O2_solutions(2,:),'LineWidth',2,'color','y','LineStyle','-.');
...
subplot(1,3,3);
hold on
plot(T,w_1(:,3),'LineWidth',3);
plot(T,O1_solutions(3,:),'color','#D95319','LineStyle','--','LineWidth',2);
plot(T,O2_solutions(3,:),'LineWidth',2,'color','y','LineStyle','-.');
...
subplot(1,3,1);
hold on
plot(T,w_1(:,1),'LineWidth',2);
plot(T,O1_solutions(4,:),'color','#D95319','LineStyle','--','LineWidth',2);
plot(T,O2_solutions(4,:),'LineWidth',2,'color','y','LineStyle','-.');
title('phi versus time');
xlabel('time(s)');
legend('angle','angle from O matrix in a','angle from O matrix in b');
hold off
...
subplot(1,3,2);
hold on
plot(T,w_1(:,2),'LineWidth',2);
plot(T,O1_solutions(5,:),'color','#D95319','LineStyle','--','LineWidth',2);
plot(T,O2_solutions(5,:),'LineWidth',2,'color','y','LineStyle','-.');
title('theta versus time');
xlabel('time(s)')
legend('angle','angle from O matrix in a','angle from O matrix in b');
hold off
...
subplot(1,3,3);
hold on
plot(T,w_1(:,3),'LineWidth',2);
plot(T,O1_solutions(6,:),'color','#D95319','LineStyle','--','LineWidth',2);
plot(T,O2_solutions(6,:),'LineWidth',2,'color','y','LineStyle','-.');
title('psi versus time');
xlabel('time(s)')
legend('angle','angle from O matrix in a','angle from O matrix in b');
hold off
